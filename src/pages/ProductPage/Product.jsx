...
function Product() {
  ...
  useEffect(() => {
    dispach(fetchProductId(idSubCatergoti));
  }, []);
      ...
      <div className="h-[600px] flex">
        <div className="w-[66%] flex gap-8" dir="rtl">
          <div className="w-[60%] h-[320px]">
            ...
            <div className="mt-5 flex flex-col">
              ...
              <span className="_font-bold">
                برند:<span className="_font-medium text-[#F5AB07]">{DatAllProduct.brand}</span>
              </span>
            </div>
            <hr />
          ...
          <div className="bg-[#F7F7F7] h-[189px] w-[340px] rounded-md pr-2 pl-2">
            ...
            <div className="mt-3">
              <bdi className="text-[#F5AB07] text-xl">
                {DatAllProduct.price}&nbsp;
                <span className="_font-bold text-[#F5AB07] text-xl">تومان</span>
              </bdi>
            </div>
        ...
        <div className="w-[34%] flex pt-5" dir="rtl">
          <div className="flex flex-col gap-8">
            ...
            <NotificationsActiveIcon sx={{ color: "#9C9C9C", width: "50px" }} />

...
function ModalMessage({ onCloce }) {
  return (
    ...
    >
      <div className="relative w-full max-w-md max-h-full border-2 mr-[30%] mt-[13%]">
        <div className="relative bg-white rounded-lg shadow">
          ...
          <div className="p-6 text-center">
            <CheckCircleOutlineIcon sx={{ color: "#6CD206", width: "100px" ,height:"100px" }}/>
